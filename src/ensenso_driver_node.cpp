...
// Services                              //it's just srv document create by ros system
...
int main(int argc, char **argv)
{
  ...
  if(argc>1)
      ...
      stereo_camera_config="/home/csl/catkin_ws/src/ensenso/config/camera_params.json";
      connect_mono=true;
  }  
  ...
  std::string tmp_str="/home/csl/mono_params.json";
